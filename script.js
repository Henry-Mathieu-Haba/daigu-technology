...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const i18n = {
        fr: {
            ...
            s1_tag:"Recherche & Développement",s1_desc:"s1_desc:"Le cœur de l'innovation souveraine. Le DAIGU LABORATORY CENTER n'est pas un laboratoire au sens classique du terme. Ce n'est pas un bâtiment rempli d'éprouvettes et de blouses blanches. C'est le centre névralgique de tout l'écosystème DAIGU. Le point-origine. L'endroit où les idées deviennent des prototypes, puis des brevets, puis des produits. DLC a une double mission : la recherche fondamentale et l'application industrielle. DLC abrite le Bureau des Projets de Convergence, l'organe le plus stratégique du Groupe. Le laboratoire est équipé d'un FabLab avancé. DLC est aussi le sanctuaire du Jumeau Numérique. Chaque produit DAIGU existe d'abord sous forme de modèle virtuel. DLC, c'est le Cerveau. Sans lui, le Corps ne sait pas où aller.",  
